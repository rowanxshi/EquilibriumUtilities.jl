...
"""
function dynamic_dampen(dampen, last_loosened, last_tightened, reference_diff, last_deviations, penultimate_deviations, history; loosen = -0.01, tighten = 0.01, min_dampen = 0.0, max_dampen = 0.99, grace_period = 50, tighten_wait = 30, loosen_wait = 50, scale = 0.85, tail = 25, convex_tol = 0.005, overshooting_share = 0.5)
